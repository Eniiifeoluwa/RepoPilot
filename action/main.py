...
target_type = "Pull Request" if etype == "pull_request" else "Issue"
...
## 📂 🎯 Predicted Category  
### 🟢 **This is most likely a {top_label.upper()} {target_type}.**  
{confidence_words} about this prediction, with {score * 100:.1f}% certainty.
